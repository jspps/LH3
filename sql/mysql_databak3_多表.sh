...
DB_NAME1=learnhall3 #要备份的数据库名字
DB_NAME2=learnhall3_log #要备份的数据库名字
...
$DUMP -u$DB_USER -p$DB_PASS --databases $DB_NAME1 $DB_NAME2 --default-character-set=utf8 --opt -Q -R --add-drop-database --skip-lock-tables > $OUT_SQL #备份
