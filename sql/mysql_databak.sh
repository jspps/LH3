...
DB_NAMES='learnhall3 learnhall3_log' #要备份的数据库名字列表
...
$DUMP -u$DB_USER -p$DB_PASS --databases $DB_NAMES --default-character-set=utf8 --opt -Q -R --add-drop-database --skip-lock-tables > $OUT_SQL #备份
