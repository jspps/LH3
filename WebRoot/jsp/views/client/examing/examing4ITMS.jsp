...
<body>
	...
	<div class="tymk_top_div">
		<div class="tymk_top_title">ITMS</div>
		<div id="sucai">
			试卷说明：<br />
			<p />
		</div>
	...
	<script type="text/javascript" language="JavaScript" charset="utf-8"
		src="jsp/js/jquery.nicescroll.js"></script>
	<script type="text/javascript">
		...
		function judgeAnswers(){
			...
			jQuery.post('<%=basePath%>'+"client/judgeAnswers", {'curExamLen':'${curExamLen}',"timediff":maxtime}, function(back) {
				...
				if (back.status) {
					if (back.status == 1) {
						var url = '<%=basePath%>'+"client/saveAnswers4ITMS?curExamLen=${curExamLen}&timers="+usetime;
						window.location.href = url;
					}else{
						var url = '<%=basePath%>'+"client/judgePage4Examing";
						var data = {"curExamLen":"${curExamLen}","timers":usetime,"url":"client/saveAnswers4ITMS"};
