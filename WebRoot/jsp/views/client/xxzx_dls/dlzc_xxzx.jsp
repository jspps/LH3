...
<meta http-equiv="description" content="学习中心登录注册" />
...
<body>
	...
	<!--内容-->
	<div class="zxdlzc_cont">
		<div class="zxdlzc_cont_img">
			<img src="jsp/imgs/client/149.jpg" />
		</div>
	</div>
	...
	<div class="xylogo_cont_div">
		...
		<div class="dlslogin_left">
			...
			<jsp:include page="Lhub_Registration_Protocol.jsp" />
	...
	<script type="text/javascript">
		function onclick2Regist(){
			window.location.href = '<%=basePath%>'+ "regLhub";
		}
		...
		function onclick2Login(){
			...
			var url = '<%=basePath%>'+ "client/loginLhub";
			var data = {"lgid":lgid,"lgpwd":lgpwd};
			var callBackIn = function(back){
				if(back.status == 1){
					window.location.href = '<%=host%>'+ "LH3Manager/go2Lhub?data="+back.data;
				}else{
					alert(back.msg);
				}
			};
