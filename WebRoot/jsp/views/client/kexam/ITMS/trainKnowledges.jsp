...
<meta http-equiv="description" content="体验模考主页_知识点训" />
	...
	<div>
		<div class="mk_tims_dbuttom_cont">
			<div class="mk_tims_nr">
				<a href="client/practiceTopics"><span
					class="mk_tims_list_xxk">题型练习</span> </a> <a
					href="client/errorTrains"><span class="mk_tims_list_xxk">错题训练</span>
				</a> <a href="client/autoSelecTopics"><span class="mk_tims_list_xxk">智能组选</span>
				</a> <a href="client/doNewTopics"><span class="mk_tims_list_xxk">只做新题</span>
				</a> <a href="client/trainKnowledges"><span class="mk_tims_list_xxkhover">知识点训练</span>
				...
				<div class="mk_ctxl_nr">
					<!--搜索框-->
					<div class="mk_zsdxl_ss">
						<form action="client/trainKnowledges" method="post" id="fm_serach_pars">
						<div class="mk_zsdxl_simg">
							<input type="text" class="ssk_text" name="strKnowlegde" id="strKnowlegde" value="${strKnowlegde}"/>
						</div>
						<div class="search_button"
							onmouseout="this.className='search_button'"
							onmouseover="this.className='search_button_hover'"
							onclick="click4Search();">查找</div>
						</form>
					</div>
				</div>
				<div class="mk_ctxl_nr" id="div_cont4txxl">
					...
					<div class="mk_ctxl_listcont">
						<div class="mk_ctxl_list_nr">
							<span class="mk_ctxl_title">${item.serial }、${item.bigtypes }</span> 
							<span class="mk_ctxl_list_cs" style="width:100px;"> 
								<label class="mk_ctxt_cs_text">总题量：${item.val }</label> 
							</span> 
							<span class="mk_ctxl_list_cs" style="width:170px;"> 
								<label class="mk_ctxt_cs_text">设置数量：</label> 
								<input type="text" class="mk_ctxl_input" onchange="inp4Change(this,${item.val },'${item.inpId}')"/> 
							</span>
							<!--  
