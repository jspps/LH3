...
<meta http-equiv="description" content="体验模考主页_知识要点" />
		...
		<div class="mk_tims_dbuttom_cont">
			<div class="mk_tims_nr">
				<span class="mk_zsyd_title">${kind.nmProduct }<br /> <label
					style="color:#939393; font-size:15px;">知识脉络</label> </span> 
				<c:choose>
				<c:when test="${isBuy }">
					<span>${kind.productFkProductid.cruces }</span>
				</c:when>
				<c:otherwise>
